...
namespace _02.CancellingTasks
{
    class Program
    {
        ...
        private static void MonitoringCancelation()
        {
            ...
            // register a delegate to fire. Notifies that cancellation has been requested
            token.Register(() =>
            {
            ...
            // cancellation on a wait handle. Someting like a subscription to the cancellation event
            Task.Factory.StartNew(() =>
            {
