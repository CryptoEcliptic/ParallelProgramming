...
namespace _16.BreakingParralelLoops
{
    class Program
    {
        public static void Demo()
        {
            ...
            var po = new ParallelOptions { CancellationToken = cts.Token }; //Cancellation tocen should pe provided via ParallelOptions
        ...
        static void Main(string[] args)
        {
            ...
            catch (OperationCanceledException) { } //Should handle this exceprion separately. It is thrown upun cancelling via cancellationToken
